...
// Пифагор начало
  ...
  function pifagor(pifag) {
    ...
    return '<div class="pifagor-square" id="result"><table rules="all" cellspacing="10" cellpadding="10" style="margin-top:20px; "><tbody>'+
         '<tr align="center">'+
         '<td colspan="2" height="110px" style="background:#bda292 ; ;border-top-left-radius: 15px;"><p class="stp" >'+name+'</p><p class="pifagor-char">'+day+'.'+months+'.'+year+'</p></td>'+
        '<td colspan="1" height="110px" style="background:#bda292 ;"><p class="stp" >Число Долі</p><p class="pifagor-char">'+rch2+'</p></td>'+
        '<td width="120px" height="110px" style="background:#bda292; border-top-right-radius:15px;"><p class="stp">Темперамент</p><p class="pifagor-char">'+temp+'</p></td>' +
        ...
        '<tr align="center">'+
          ...
          '<td width="120px" height="110px" style="background:#bda292 ;><p class = "pifagor-char"></p><p class = "stp">Ціль</p><p class="pifagor-char">'+target+'</p></td>'+
        ...
        '<tr align="center">'+
          ...
          '<td width="120px" height="110px" style="background:#bda292 ;><p class = "pifagor-char"></p><p class = "stp">Сімʼя</p><p class="pifagor-char">'+fam+'</p></td>'+
        ...
        '<tr align="center">'+
          ...
          '<td width="120px" height="110px"><p class = "pifagor-char"></p><p class = "stp">Памʼять</p><p class="pifagor-char">'+fkol_9+'</p></td>'+
           '<td width="120px" height="110px" style="background:##bda292 ;><p class = "pifagor-char"></p><p class = "stp">Звички</p><p class="pifagor-char">'+hab+'</p></td>'+
          


        '<tr align="center">'+
          '<td width="120px" height="110px" style="background:#bda292; border-bottom-left-radius:15px;"><p class = "stp">Самооцінка</p><p class = "pifagor-char">'+selfesteem+'</p><p class = "stp"></p><p class = "stp"></p></td>'+                                                     
          '<td width="120px" height="110px" style="background:#bda292;"><p class = "stp">Побут</p><p class = "pifagor-char">'+life+'</p><p class = "stp"></p><p class = "stp"></p></td>'+                                                                                                                                           
